...
## Features
- ≡ƒô¥ Generate research, outlines, resources and lessons reports
- ≡ƒîÉ Aggregates over 20 web sources per research to form objective and factual conclusions
- ≡ƒûÑ∩╕Å Includes an easy-to-use web interface (HTML/CSS/JS)
- ≡ƒöì Scrapes web sources with javascript support
- ≡ƒôé Keeps track and context of visited and used web sources
- ≡ƒôä Export research reports to PDF and more...
