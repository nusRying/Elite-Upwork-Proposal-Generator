name:	nusRying/Multi-Agent-RL-for-Autonomous-Drone-Swarms
description:	
--
...
- Γ£à CTDE with centralized critic implementation
- Γ£à Attention mechanism for neighbor aggregation
- Γ£à PyBullet physics environment with rigid body dynamics
- Γ£à 3D visualization tools
- Γ£à GPU support for training
